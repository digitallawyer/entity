...
class CorporationsControllerTest < ActionController::TestCase
  ...
  test "should create corporation" do
    assert_difference('Corporation.count') do
      post :create, corporation: { extension: @corporation.extension, name: @corporation.name, share_number: @corporation.share_number, share_value: @corporation.share_value }
    end
  ...
  test "should update corporation" do
    patch :update, id: @corporation, corporation: { extension: @corporation.extension, name: @corporation.name, share_number: @corporation.share_number, share_value: @corporation.share_value }
    assert_redirected_to corporation_path(assigns(:corporation))
  end
